# -*- coding: utf-8 -*-
"""
Angel One - placing stop loss using ltp
...
def place_sl_limit_order(instrument_list,ticker,buy_sell,price,quantity,exchange="NSE"):
    params = {
                ...
                "duration":"DAY",
                "price":price-0.05 if buy_sell=="BUY" else price+0.05,
                "triggerprice":price,
                "quantity":quantity
                }
...
place_sl_limit_order(instrument_list, "HCLTECH", "BUY", ltp+20, 1) #price needs to be greater than LTP for buy orders
place_sl_market_order(instrument_list, "HCLTECH", "BUY", ltp+20, 1) #price needs to be greater than LTP for buy orders
